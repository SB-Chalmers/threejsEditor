...
import { Activity, Camera, GitBranch, Grid3X3, View } from 'lucide-react';
...
interface BottomToolbarProps {
  ...
  onToggleGrid: () => void; onToggleSnap: () => void; onToggleFPS: () => void; onSwitchCameraType: (type: CameraType) => void; onSetCameraView: (view: CameraView) => void; onOpenDesignGraph: () => void;
}

export const BottomToolbar: React.FC<BottomToolbarProps> = ({ showGrid, snapToGrid, showFPS, buildingStats, currentCameraType, onToggleGrid, onToggleSnap, onToggleFPS, onSwitchCameraType, onSetCameraView, onOpenDesignGraph }) => {
